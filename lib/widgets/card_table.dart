    ...
    (
      ...
      [
        ...
        (
          children: 
          [
            _SingleCard(color: Colors.deepPurple, icon: Icons.departure_board_sharp, text: 'Departure'),
            _SingleCard(color: Colors.pinkAccent, icon: Icons.audiotrack, text: 'Audio'),
          ]
        ),
        ...
        (
          children: 
          [
            _SingleCard(color: Colors.deepPurple, icon: Icons.camera_outlined, text: 'Camera'),
            _SingleCard(color: Colors.pinkAccent, icon: Icons.computer_sharp, text: 'Devices'),
          ]
        ),
...
class _SingleCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    (
      ...
      children: 
      [
        CircleAvatar(backgroundColor: this.color, child: Icon(this.icon, size: 35, color: Colors.white,), radius: 30,),
        SizedBox(height: 10),
